...
(function dartProgram() {
  ...
  S = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new S.main_closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
  ...
  S.main_closure.prototype = {
    call$1: function(e) {
      ...
      t1 = $.$get$tempInput().value;
      t2 = $.len = t1.length;
      t3 = t2 - 2;
      if (t3 < 0)
        return H.ioore(t1, t3);
      $.type = t1[t3];
      t3 = C.JSString_methods.substring$2(t1, 0, t3);
      $.number = t3;
      t3 = $.number = P.int_parse(t3);
      t1 = $.type;
      if (t1 === "k") {
        t1 = $.$get$output();
        t3 = H.S(t3) + " kg=";
        t2 = H.numTypeCheck($.number);
        if (typeof t2 !== "number")
          return t2.$mul();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t3 + C.JSNumber_methods.toStringAsFixed$1(t2 * 0.454, 3) + " lb");
      } else if (t1 === "l") {
        t1 = $.$get$output();
        t3 = H.S(t3) + " lb=";
        t2 = H.numTypeCheck($.number);
        if (typeof t2 !== "number")
          return t2.$div();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t3 + C.JSDouble_methods.toStringAsFixed$1(t2 / 0.454, 3) + " kg");
      } else {
        t1 = $.$get$output();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, "\u8a18\u5f97\u55ae\u4f4d");
      }
      return;
    },
    $signature: 18
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "tempInput", "$get$tempInput", function() {
      return H.interceptedTypeCheck(W.querySelector("#b"), "$isInputElement");
    });
...
//# sourceMappingURL=kgtolb.js.map
